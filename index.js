...
export default class ViewSlider extends React.Component {
  ...
  render(){
    const {dots, dotActiveColor, dotInactiveColor, slideCount} = this.props
    ...
    return(
      <View style={[{width, height: this.props.height}, this.props.style]}>
        ...
        {dots && <Dots activeColor={dotActiveColor} inactiveColor={dotInactiveColor} count={slideCount} activeDot={activeDot} />}
      </View>
    )
  }
}